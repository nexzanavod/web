...
if (isset($_POST['save'])) { // if save button on the form is clicked
    ...
    if (!in_array($extension, ['jpg', 'jpeg', 'png'])) {
        ...
        {
            $sql = "UPDATE `admin` SET `name` = '$name', `username` = '$username', `img` = 'assets/img/profiles/$filename' WHERE `user_id` = '$uid'";
...
{ // if save button on the form is clicked
    ...
    $sql = "UPDATE `admin` SET `password` = '$newpassword' WHERE `user_id` = '$uid'";
